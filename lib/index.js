var salutations = {	"doctor":1, "dr":1,	"miss":1, "mister":1, "mr":1, "mrs":1, "ms":1, "prof":1, "professor":1 };
var suffixes = { 'jr':1, 'sr':1 };

function hasName(obj, propName) {
	return !!obj[propName.replace(/\.$/, '').toLowerCase()];
}
exports.normilize = function lexicalToWestern(value){
